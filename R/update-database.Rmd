...
This is the list of codes for dry forests:

```sql

select string_agg(value::varchar,',') from ivc_americas WHERE ivc_format='Tropical Seasonally Dry Forest' ;
--  570,134,294,296,561,562,563,565,566,567,568,571,572,573,574,575,872
